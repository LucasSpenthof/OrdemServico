...
public class ServidorService {
	...
	public ServidorDTO findById(Long id){
		...
		Servidor servidor = obj.orElseThrow(() -> new ResourceAccessException("Não encontrado"));
		return new ServidorDTO(servidor);
	}
	
	@Transactional
	public ServidorDTO instert(ServidorDTO dto) {
	...
	public void delete(Long id) {
		try {
			...
			throw new DataBaseException("Servidor em uso, umpossível excluir");
		}
